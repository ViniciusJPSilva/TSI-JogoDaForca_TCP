...
WORD_LIST = [
    ...
    ("arcano", "Misterioso"),
    ("ebulicao", "Ebulição"),
    ("inefavel", "Indescritível"),
    ("paroxismo", "Auge"),
    ("inocuo", "Inofensivo"),
    ("reles", "Insignificante"),
    ("alhures", "Em outro lugar"),
    ("convalescenca", "Recuperação"),
    ...
    ("inexoravel", "Impiedoso"),
    ("quimerico", "Fantástico"),
    ("sublime", "Excepcional"),
    ("zen", "Meditação"),
    ("subterfugio", "Evasão"),
    ("hipotetico", "Suposto"),
...
class Game: #
    ...
    def get_final_message(self): #
        ...
        return message_to_cliente + "Jogar novamente? [S|n]: "
    #
# class Game
